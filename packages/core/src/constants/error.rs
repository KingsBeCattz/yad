...
pub const MALFORMED_FILE: &'static str = "The provided YAD FILE is malformed.";
pub const MALFORMED_VERSION_HEADER: &'static str = "The provided YAD FILE has a malformed version header.";
...
pub const MALFORMED_KEY_VECTOR: &'static str = "The provided vector to decode as a key is not a key.";
pub const KEY_NAME_OF_LENGTH_ZERO: &'static str = "Your key name must have at least one character.";
pub const MALFORMED_ROW_VECTOR: &'static str = "The provided vector to decode as a row is not a row.";
pub const ROW_NAME_OF_LENGTH_ZERO: &'static str = "Your row name must have at least one character.";
